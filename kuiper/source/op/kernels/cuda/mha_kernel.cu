...
__global__ void multi_head_attention_prefill_kernel(int32_t start_pos, int32_t T, int32_t seq_len,
...
//                    int32_t kv_dim, int32_t kv_mul, int32_t head_size, const tensor::Tensor&
//                    mha_out, const tensor::Tensor& query_tensor, const tensor::Tensor&
//                    score_tensor, const tensor::Tensor& key_cache_tensor, const tensor::Tensor&
//                    value_cache_tensor, base::DeviceType device_type, CudaConfig* config) {
//   UNUSED(device_type);
