...
// __device__ uint4 dequantize_s4_to_fp16x2(const uint32_t& source) {
//   uint4 result;

//   uint32_t* h = reinterpret_cast<uint32_t*>(&result);
//   const uint32_t i4s = reinterpret_cast<const uint32_t&>(source);
...
//   register
//   // packing format and the fact that we force our integers to be unsigned, and account for this
//   in
...
//   instructions
//   // if I use the half2 ctor. In this case, I chose performance reliability over code
//   readability.
